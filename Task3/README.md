...
![Containers Diagram](../images/Task3_PropDevelopment_С4_model.png)



## Требования безопасноти к внешним интеграциям
...
4. Мониторинг и логирование:
   ...
   - В системе мониторинга должны быть выставлены пороги и уведомления для метрики приложения 
